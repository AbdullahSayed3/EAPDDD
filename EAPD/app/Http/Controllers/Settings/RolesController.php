...
use App\Forms\Settings\RolesForm;
...
class RolesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->table = [
            ...
            ['name' => 'name', 'display' => trans('awt.اسم المجموعه'), 'data' => 'name', 'orderable' => 'true', 'searchable' => 'true'],
            ['name' => 'nice_name', 'display' => trans('awt.الاسم اللطيف للمجموعه'), 'data' => 'nice_name', 'orderable' => 'true', 'searchable' => 'true'],
    ...
    public function index(): View
    {
        ...
        return view($this->view.'.roles', compact('active', 'table_rows', 'route'));
    }
    ...
    public function update(int $id, FormBuilder $formBuilder): RedirectResponse
    {
        ...
        $model->update($data);
        if (isset($request->permissions)) {
            $permissionNames = Permission::whereIn('id', (array) $request->permissions)
                ->where('guard_name', 'web') // optional but good for safety
                ->pluck('name')
                ->toArray();
