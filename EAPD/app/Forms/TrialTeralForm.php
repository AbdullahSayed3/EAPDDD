...
class TrialTeralForm extends Form
{
    public function buildForm()
    {
        ...
        $this->add('clone', 'static', [
            'label' => false,
            'tag' => 'div', // Tag to be used for holding static data,
            'wrapper' => ['class' => 'form-group row col-md-12 '],
        ...
        $this->add('back', 'static', [
            ...
            'wrapper' => ['class' => 'form-group row col-md-2 pull-left ml-1'],
            'attr' => ['class' => 'col-md-12 btn btn-danger ', 'href' => route('courses.index')],
