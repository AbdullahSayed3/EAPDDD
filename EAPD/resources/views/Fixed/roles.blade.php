...
@section('content')
    ...
    <!--page title-->
    <x-base.breadcrumb title="{{ $active }}" :translate="true" :breadcrumbs="[['label' => 'الصفحة الرئيسية', 'url' => route('home')], ['label' => $active]]" />
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">{{ awtTrans('main.close') }}</button>
                    ...
                    <div class="card-body- pt-3 pb-4">
                        <div class="table-responsive">
                            <table id="datatable" class="table table-bordered table-striped" cellspacing="0"
                                ...
                                <thead>
                                    <tr>
                                        <td class='text-end' style="font-weight: bolder">#</td>
                                        <td class='text-end' style="font-weight: bolder">{{trans('awt.اسم المجموعه')}}</td>
                                        <td class='text-end' style="font-weight: bolder">{{trans('awt.الاسم اللطيف للمجموعه')}}</td>
                                        <td class='text-end' style="font-weight: bolder">{{trans('awt.العمليات')}}</td>
