                            ...
                            <table id="datatable" class="table table-bordered table-striped" cellspacing="0"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td class='text-end' style="font-weight: bolder">{{awtTrans('name')}}</td>
                                        <td class='text-end' style="font-weight: bolder">{{trans('awt.email_address')}}</td>
                                        <td class='text-end' style="font-weight: bolder">{{awtTrans('edit')}}</td>
