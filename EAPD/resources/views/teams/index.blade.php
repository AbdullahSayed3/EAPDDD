...
@section('content')
    ...
    <!--page title-->
    <x-base.breadcrumb title="{{App::getLocale() == 'en' ? 'Team': 'فريق العمل'}}" :translate="true" :breadcrumbs="[['label' => 'الصفحة الرئيسية', 'url' => route('home')], ['label' =>App::getLocale() == 'en' ? 'Team': 'فريق العمل']]" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route($route . '.create') }}" class="btn btn-primary float-left"><i
                                        class="fa fa-plus-square-o"></i>{{ awtTrans('اضافه') }}</a>
                                <!-- Modal -->
        ...
        $(document).on('click', '.delete-row', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    try {
                        // Try to parse Laravel JSON error response
