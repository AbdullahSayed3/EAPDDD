        ...
        <div class="PDFcontent">
            ...
            <div class="data-table">
                ...
                <table class="table table-bordered " cellspacing="0" style="text-align: center;">
                    ...
                    <tbody>
                    <tr>
                        <td>{{awtTrans('اسم المركز / الشريك')}}</td>
                        <td>{{$model->name}}</td>
                    </tr>
                    <tr>
                        <td>{{awtTrans('مجال العمل')}}</td>
                        <td>{{$model->field->name_ar}}</td>
                    </tr>

                    <tr>
                        <td>{{awtTrans('طبيعة الجهة')}}</td>
                        <td>{{$model->natural->name_ar}}</td>
                    </tr>


                    <tr>
                        <td>{{awtTrans('العنوان')}}</td>
                        <td>{{$model->address}}</td>
                    </tr>

                    <tr>
                        <td>{{awtTrans('اسم نقطة الاتصال')}}</td>
