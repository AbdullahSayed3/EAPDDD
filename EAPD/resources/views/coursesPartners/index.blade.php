...
@section('content')
    ...
    <!--page title-->
    <x-base.breadcrumb title="مراكز التميز والشركاء" :breadcrumbs="[
        ['label' => 'الصفحة الرئيسية', 'url' => route('home')],
        ['label' => 'الدورات التدريبية', 'url' => route('courses.index')],
        ['label' => 'مراكز التميز والشركاء'],
    ]" />
            ...
            <div class="col-xl-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-md-12">
                                <x-base.fillBtn :href="route($route . '.create')" icon="fa-plus-square-o" :label="awtTrans('اضافه مركز جديد')" float="start" />
