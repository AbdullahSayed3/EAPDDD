...
@section('content')
    ...
    <!--page title-->
    <x-base.breadcrumb title="{{ 'jobs_types' }}" :translate="true" :breadcrumbs="[['label' => 'الصفحة الرئيسية', 'url' => route('home')], ['label' => 'jobs_types']]" />
                    ...
                    <div class="card-body- pt-3 pb-4">
                        <div class="table-responsive">
                            <table id="datatable" class="table table-bordered table-striped" cellspacing="0"
                                ...
                                <thead>
                                    <tr>
                                        {{-- <td class='text-end' style="font-weight: bolder">{{awtTrans('name_ar')}}</td>
                                        <td class='text-end' style="font-weight: bolder">{{awtTrans('name_en')}}</td>
