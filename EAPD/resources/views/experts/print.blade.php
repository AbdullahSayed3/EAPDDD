        ...
        <div class="header">
            ...
            <div class="data-table">
                <table class="table table-bordered " cellspacing="0" style="text-align: center;">
                    <tbody>
                        <tr>
                            <td>{{ awtTrans('الاسم') }}</td>
                            <td>{{ $model->name }}</td>
                        </tr>
                        <tr>
                            <td>{{ awtTrans('الدولة') }}</td>
                            <td>{{ getCountry($model->country) }}</td>
                        </tr>

                        <tr>
                            <td>{{ awtTrans('التخصص') }}</td>
                            <td>{{ $model->specialist }}</td>
                        </tr>


                        <tr>
                            <td>{{ awtTrans('التخصص الفرعي') }}</td>
                            <td>{{ $model->sub_specialist }}</td>
                        </tr>

                        <tr>
                            <td>{{ awtTrans('المؤهل الدراسي') }}</td>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ awtTrans($model->gender) }}
                            </td>
                        </tr>

                        <tr>
                            <td>
                                {{ awtTrans('اللغات التي يجيدها') }}
                            </td>
                        ...
                        <tr>
                            <td>
                                {{ awtTrans('سوابق التعاقدات مع الوكالة إن وجدت') }}
                            </td>
                        ...
                        <tr>
                            <td>
                                {{ awtTrans('الدولة الموفد إليها حالياً') }}
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                {{ awtTrans('الجهة الموفد إليها حالياً') }}
                            </td>
                        ...
                        <tr>
                            <td>
                                {{ awtTrans('التكلفة السنوية') }}
                            </td>
                            <td>
                                <p>{{ $model->cost }} {{ awtTrans('جنيه مصرى') }}</p>
                            </td>
                        </tr>
