...
@section('content')
    ...
    <!--page title-->
    <x-base.breadcrumb title="{{ App::getLocale() == 'en' ? 'المقالات': 'المقالات' }}" :translate="true" :breadcrumbs="[['label' => 'الصفحة الرئيسية', 'url' => route('home')], ['label' => App::getLocale() == 'en' ? 'المقالات': 'المقالات' ]]" />
