        ...
        <div class="PDFcontent">
            ...
            <div class="data-table">
                ...
                <table class="table table-bordered " cellspacing="0" style="text-align: center;">
                    ...
                    <tbody>
                        <tr>
                            <td>{{ awtTrans('البرنامج / المنحة') }}</td>
                            <td>
                                <p>{{ $model->program }}</p>
                            </td>
                        </tr>
                        <tr>
                            <td>{{ awtTrans('الجهة') }}</td>
                            <td>
                                <p>{{ $model->owner }}</p>
                        ...
                        <tr>
                            <td>{{ awtTrans('تاريخ البدء') }}</td>
                            <td>{{ $model->start_date->format('Y-m-d') }}</td>
                        </tr>
                        <tr>
                            <td>{{ awtTrans('تاريخ الإنتهاء') }}</td>
                            <td> {{ $model->end_date->format('Y-m-d') }}</td>
                        </tr>
                        <tr>
                            <td>
                                {{ awtTrans('مجال الدراسة') }}
                            </td>
                        ...
                        <tr>
                            <td>
                                {{ awtTrans('عدد الدراسين') }}
                            </td>

                            <td>
                                {{ $model->learners->count()}}
                            </td>
                        </tr>
