                                        ...
                                        <thead class="thead-light">
                                            <tr>
                                                <th colspan="4" style="text-align: center;">
                                                    أ{{ awtTrans('اعمال الوكالة العام المالي') }} {{ $key + 1 }} /
                                                    {{ $key }}</th>
                                            </tr>
                                            <tr>
                                            ...
                                            @if (getRequest('cost') != null)
                                                ...
                                                <tr>
                                                    <th colspan="2">
                                                        {{ awtTrans('التكلفة الإجمالية للدورات التدريبية') }}</th>
                                                    <td colspan="2">{{ $item['total_c_cost'] }}
                                                        {{ awtTrans('جنيه مصرى') }}</td>
                                                </tr>
                                                <tr>
                                                    <th colspan="2">{{ awtTrans('التكلفة الإجمالية للمنح والمعونات') }}
                                                    </th>
                                                    <td colspan="2">{{ $item['total_a_cost'] }}
                                                        {{ awtTrans('جنيه مصرى') }}</td>
                                                </tr>

                                                <tr>
                                                    <th colspan="2">{{ awtTrans('التكلفة الإجمالية للخبراء') }}</th>
                                                    <td colspan="2">{{ $item['total_e_cost'] }}
                                                        {{ awtTrans('جنيه مصرى') }}</td>
                                                </tr>
                                            @endif
                                        </thead>
