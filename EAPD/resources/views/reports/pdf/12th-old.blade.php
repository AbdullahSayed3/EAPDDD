        ...
        <td>
            ...
            <div class="page" style="text-align: center">
                ...
                <table class="mytable">
                    ...
                    {{--</tfoot>--}}
                    <tbody>
                    @if(getRequest('details')=="details222")

                        @foreach($aidsByCountry as $country=>$aid)
                            @php $mAids=$aid['aids'];  $Aidsuppliers=$mAids[0]->suppArray @endphp
                            <tr>
                                <td rowspan="{{$aid['total_suppliers']+count($Aidsuppliers)}}">{{$mAids[0]->id}}</td>
                                <td rowspan="{{$aid['total_suppliers']+count($Aidsuppliers)}}">{{getCountry($mAids[0]->country_id)}}</td>
                            ...
                            @foreach($mAids as $a)
                                ...
                                <tr>
                                    <td rowspan="{{$rowSpan}}"><a
                                                href="{{route('aids.show',[$a->id])}}">{{$a->type->name_ar}}</a></td>
                                    <td rowspan="{{$rowSpan}}">{{$a->ship_date->format('Y/m/d')}}</td>
                                    <td rowspan="{{$rowSpan}}">{{$a->arrive_date->format('Y/m/d')}}</td>
                                    @if(getRequest('details')=="details")

                                        <td rowspan="{{count($mAids)}}">{{$Aidsuppliers[0]['details']}}</td>
                                        <td rowspan="{{count($mAids)}}">{{$Aidsuppliers[0]['cost']}} {{awtTrans('جنيه')}}</td>
                                ...
                                @endforeach
                                {{--<tr>--}}
                                {{--<td>55 طنًا من المساعدات الطبية والعلاجية</td>--}}
                                {{--<td>5،500 جنيه</td>--}}
                    ...
                    @else
                        ...
                        @foreach($aidsByCountry as $country=>$aid)
                            @php $mAids=$aid['aids'];  $Aidsuppliers=$mAids[0]->suppArray; $totalSupsTest=count($mAids); @endphp

                            @foreach($mAids as $testSup)
                                @php $mAidsuppliers=$testSup->suppArray; $rowSpan=count($mAidsuppliers) @endphp


                                @if(count($mAidsuppliers)>1)

                                    @php $totalSupsTest+=count($mAidsuppliers)-1 @endphp
                            ...
                            <tr>
                                <td data-aids="{{count($mAids)}}" data-sups="{{count($Aidsuppliers)}}"
                                    rowspan="{{$totalSupsTest}}">{{$mAids[0]->id}}</td>
                                <td rowspan="{{$totalSupsTest}}">{{getCountry($mAids[0]->country_id)}}</td>
                                <td rowspan="{{count($Aidsuppliers)}}"><a
                                            href="{{route('aids.show',[$mAids[0]->id])}}">{{$mAids[0]->type->name_ar}}</a>
                                </td>
                                <td rowspan="{{(count($Aidsuppliers)==0?1:count($Aidsuppliers))}}">{{$mAids[0]->ship_date->format('Y/m/d')}}</td>
                                <td rowspan="{{(count($Aidsuppliers)==0?1:count($Aidsuppliers))}}">{{$mAids[0]->arrive_date->format('Y/m/d')}}</td>
                                @if(getRequest('details')=="details")

                                    <td>{{getSupplier($Aidsuppliers[0]['id'])}}</td>
                                    ...
                                    @php unset($Aidsuppliers[0]) @endphp
                                @endif
                                <td rowspan="{{1+(count($Aidsuppliers)==0?0:count($Aidsuppliers))}}">{{$mAids[0]->cost}} {{awtTrans('جنيه')}}</td>
                            </tr>
                            @foreach($Aidsuppliers as $aiSupp)
                                ...
                                <tr>
                                    ...
                                    @if(getRequest('details')=="details")
                                        ...
                                        <td rowspan="1">{{getSupplier($aiSupp['id'])}}</td>

                                        <td rowspan="1">{!! $aiSupp['details'] !!}</td>
                                        @if($aiSupp['cost']==null)
                                        ...
                                        @else
                                            ...
                                            <td rowspan="1">{{$aiSupp['cost']}} {{awtTrans('جنيه')}}</td>
                            ...
                            @foreach($mAids as $a)
                                ...
                                <tr>
                                    <td rowspan="{{(count($Aidsuppliers)==0?1:count($Aidsuppliers))}}">
                                        <a
                                                href="{{route('aids.show',[$a->id])}}">{{$a->type->name_ar}}</a>
                                    </td>
                                    <td rowspan="{{(count($Aidsuppliers)==0?1:count($Aidsuppliers))}}">{{$a->ship_date->format('Y/m/d')}}</td>
                                    <td rowspan="{{(count($Aidsuppliers)==0?1:count($Aidsuppliers))}}">{{$a->arrive_date->format('Y/m/d')}}</td>
                                    @if(getRequest('details')=="details")
                                        ...
                                        @else
                                            <td rowspan="1">{{getSupplier($Aidsuppliers[0]['id'])}}</td>
                                    ...
                                    @endif
                                    <td rowspan="{{1+(count($Aidsuppliers)==0?0:count($Aidsuppliers))}}">{{$a->cost}} {{awtTrans('جنيه')}}</td>
                                </tr>
