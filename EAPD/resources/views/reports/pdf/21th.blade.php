                    ...
                    <div class="page" style="text-align: center">
                        ...
                        <div class="table-content">
                            <div class="page-title">
                                <h3 class="weight500 d-block pr-3 mb-5"> {{ awtTrans('القوافل المقدمة') }}</h3>
                            </div>
                        </div>
                        <table class="mytable">
                                ...
                                @if (getRequest('details') == 'details1')
                                    ...
                                    @foreach ($aidsByCountry as $country => $aid)
                                        ...
                                        <tr>
                                            ...
                                            <td rowspan="{{ count($mAids) }}">{{ getCountry($mAids[0]->country_id) }}
                                            </td>
                                        ...
                                        @foreach ($mAids as $a)
                                            ...
                                            <tr>
                                                ...
                                                <td rowspan="{{ $rowSpan }}">{{ $a->ship_date->format('Y/m/d') }}
                                                </td>
                                                <td rowspan="{{ $rowSpan }}">
