        ...
        <div class="col-xl-12">
            <div class="mb-4">
                ...
                <div class="card-body- p-4">
                    ...
                    {{-- @foreach ($appsDetails as $key => $value) --}}
                    {{-- <div class="row justify-content-center mt-5"> --}}
                    {{-- <div class="col-10"> --}}
                    {{-- <div class="table-responsive"> --}}
                    {{-- <table class="table table-bordered " cellspacing="0" style="text-align: center;"> --}}
                    ...
                    {{-- <tr> --}}
                    {{-- <th>{{awtTrans('اجمالى عدد الدورات')}}</th> --}}
                    {{-- <td>{{count($appsCourses)}}</td> --}}
                    {{-- <th>{{awtTrans('إجمالى عدد المتدربين')}}</th> --}}
                    {{-- <td colspan="2">{{count($appsDetails)}}</td> --}}
                    {{-- </tr> --}}
                    {{-- <tr> --}}
                    {{-- <th>{{awtTrans('عدد الدورات النوعية')}}</th> --}}
                    {{-- <td>{{$appsDetails[$key]['city']}}</td> --}}
                    {{-- <th>{{awtTrans('عدد دورات الجيش والشرطة')}}</th> --}}
                    {{-- <td colspan="2">{{$appsDetails[$key]['other']}}</td> --}}
                    {{-- </tr> --}}
                    {{-- <tr> --}}
                    {{-- <th>{{awtTrans('رقم الدورة')}}</th> --}}
                    {{-- <th>{{awtTrans('الدورة التدريبية')}}</th> --}}
                    ...
                    {{-- <tr> --}}
                    {{-- <th>{{awtTrans('التكلفة')}}</th> --}}
                    {{-- <td colspan="2">{{$appsDetails[$key]['city_cost']}}</td> --}}
                    {{-- <td colspan="2">{{ $appsDetails[$key]['other_cost']}}</td> --}}
                    {{-- </tr> --}}
                    {{-- <tr> --}}
                    {{-- <th colspan="2">{{awtTrans('التكلفة الإجمالية')}}</th> --}}
                    {{-- <td colspan="3">{{ $appsDetails[$key]['other_cost']+$appsDetails[$key]['city_cost']}}</td> --}}
                    {{-- </tr> --}}
                    {{-- </tfoot> --}}
                    {{-- <tbody> --}}
                    {{-- @foreach ($appsCourses as $course) --}}
                    {{-- <tr> --}}
                    {{-- <td>{{$course->id}}</td> --}}
                    {{-- <td><a href="{{route('courses.show',[$course->id])}}">{{$course->name_ar}}</a></td> --}}
                    {{-- <td>{{$course->organization->name}}</td> --}}
                                    ...
                                    @if ($t == 0)
                                        <div class="page-title">
                                            ...
                                            <h3 class="weight500 d-block pr-3 mb-5">
                                                1- {{ awtTrans('بيانات المشاركة بدورات الوكالة') }}</h3>
                                        </div>
                                        @php($t = 1)
                                    @endif
                                    ...
                                    <table class="table table-bordered " cellspacing="0" style="text-align: center;">
                                        ...
                                        <tfoot class="thead-light">
                                            ...
                                            <tr>
                                                <th colspan="2">{{ awtTrans('التكلفة الإجمالية') }}</th>
                                                <td colspan="3">
                                                    {{ $coursesDetails[$key]['other_cost'] + $coursesDetails[$key]['city_cost'] }}
                                                </td>
                                            </tr>
                                        </tfoot>
                                        <tbody>
                    ...
                    <div class="row ">
                        <div class="col-12">
                            <div class="page-title">
                                <h3 class="weight500 d-block pr-3">2- {{ awtTrans('الإجمالى') }} </h3>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center mt-5">
