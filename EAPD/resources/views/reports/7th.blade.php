                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control selc_cour_typ" name="course">
                                    <option></option>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <label> {{ awtTrans('بيانات الدورة') }}</label>

                                        <ul style="list-style:none;">
                                            <li><input type="checkbox" id="course_name" name="print_choices[course_name]"
                                                    value="course_name">
                                                <label for="course_name">
                                                    {{ awtTrans('اسم الدورة التدريبية') }}</label>
                                            </li>

                                            <li><input type="checkbox" id="course_type" name="print_choices[course_type]"
                                                    value="course_type">
                                                <label for="course_type">
                                                    {{ awtTrans('نوع الدورة') }}</label>
                                            </li>

                                            <li><input type="checkbox" id="course_natural"
                                                    name="print_choices[course_natural]" value="course_natural">
                                                <label for="course_natural">
                                                    {{ awtTrans('طبيعة الدورة') }}</label>
                                            </li>

                                            <li><input type="checkbox" id="course_field" name="print_choices[course_field]"
                                                    value="course_field">
                                                <label for="course_field">
                                                    {{ awtTrans('مجال التعاون') }}</label>
                                            </li>

                                            <li><input type="checkbox" id="course_trainees"
                                                    name="print_choices[course_trainees]" value="course_trainees">
                                                <label for="course_trainees">
                                                    {{ awtTrans('اسم منسق الدورة') }}</label>
                                            </li>

                                            <li><input type="checkbox" id="course_content"
                                                    name="print_choices[course_content]" value="course_content">
                                                <label for="course_content">
                                                    {{ awtTrans('المحتوى') }}</label>
                                            </li>
                                            <li><input type="checkbox" id="course_docs" name="print_choices[course_docs]"
                                                    value="course_docs">
                                                <label for="course_docs">
                                                    {{ awtTrans('وثائق ذات صلة') }}</label>
                                            </li>
                                            ...
                                            <li><input type="checkbox" id="course_location"
                                                    name="print_choices[course_location]" value="course_location">
                                                <label for="course_location">
                                                    {{ awtTrans('مكان الإنعقاد') }}</label>
                                            </li>
                                            <li><input type="checkbox" id="course_org" name="print_choices[course_org]"
                                                    value="course_org">
                                                <label for="course_org">
                                                    {{ awtTrans('الجهة المنظمة') }}</label>
                                            </li>
                                            <li><input type="checkbox" id="course_countries"
                                                    name="print_choices[course_countries]" value="course_countries">
                                                <label for="course_countries">
                                                    {{ awtTrans('الدول المشاركة') }}</label>
                                            </li>
                                            <li><input type="checkbox" id="course_apps" name="print_choices[course_apps]"
                                                    value="course_apps">
                                                <label for="course_apps">
                                                    {{ awtTrans('إجمالي عدد المتدربين') }}</label>
                                            </li>
                                            <li><input type="checkbox" id="course_female"
                                                    name="print_choices[course_female]" value="course_female">
                                                <label for="course_female">
                                                    {{ awtTrans('عدد المتدربات') }}</label>
                                            </li>
                                            <li><input type="checkbox" id="course_cost" name="print_choices[course_cost]"
                                                    value="course_cost">
                                                <label for="course_cost">
                                                    {{ awtTrans('التكلفة الإجمالية') }}</label>
                                            </li>
                                            <li><input type="checkbox" id="course_notes"
                                                    name="print_choices[course_notes]" value="course_notes">
                                                <label for="course_notes">
                                                    {{ awtTrans('ملاحظات أخرى') }}</label>
                                            </li>
                                        </ul>
                                        <div class="form-group">
                                            <input type="checkbox" id="course_app" name="print_choices[course_app]"
                                                value="course_app"> {{ awtTrans('بيانات المشاركين في الدورة') }}</input>
                                        </div>
