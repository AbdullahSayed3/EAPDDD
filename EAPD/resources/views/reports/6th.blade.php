                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control selc_country" name="country[]" multiple>
                                    <option></option>
                                    @foreach (getCountries() as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ in_array($key, getRequest('country') !== null ? getRequest('country') : []) ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        @if (isset($_GET['inv']))
                            <input type="hidden" autocomplete="off" name="inv" value="{{ $_GET['inv'] }}">
                        @endif
                        <div class="form-group row">
            ...
            <div class="mb-4">
                ...
                <div class="card-body- p-4">
                                ...
                                <table class="table table-bordered " cellspacing="0" style="text-align: center;">
                                    ...
                                    <tfoot class="thead-light">
                                        <tr>
                                            ...
                                            @if (isset($_GET['inv']) && $_GET['inv'] == 1)
                                                <th>{{ $countryArrayData['total_in_courses'] }}</th>
                                            ...
                                            <th>{{ $countryArrayData['total_army'] + $countryArrayData['total_police'] }}
                                            </th>
                    ...
                    <div class="row ">
                        <div class="col-12">
                            <div class="page-title">
                                <h3 class="weight500 d-block pr-3"> الإجمالى </h3>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center mt-5">
                                ...
                                <table class="table table-bordered" cellspacing="0">
                                    ...
                                    <tbody class="thead-light">
                                        <tr>
                                            ...
                                            @if (isset($_GET['inv']) && $_GET['inv'] == 1)
                                                <td>{{ $countryArrayData['total_in_courses'] }}</td>
                                            @else
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">{{ $countryArrayData['cost'] }}
