                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group row">
                            ...
                            <label for="" class="col-sm-2 col-form-label">{{ awtTrans('نوع المعونة') }}</label>
                            <div class="col-sm-4">
                                <select class="form-control " name="type">
                                    <option></option>
                                    @foreach (\App\Models\AidType::all() as $key)
                                        <option value="{{ $key->id }}"
                                            {{ getRequest('type') == $key->id ? 'selected' : '' }}>
                                            {{ $key->name_ar }}
                                        </option>
                                    @endforeach
                                </select>
                                                ...
                                                <tr>
                                                    ...
                                                    @if (getRequest('details') == 'details')
                                                        ...
                                                        @if ($Aidsuppliers[0]['cost'] == null)
                                                            <td rowspan="1">0</td>
                                                        @else
                                                            <td rowspan="1">{{ $Aidsuppliers[0]['cost'] }}
                                                                {{ awtTrans('جنيه') }}</td>
                                                        @endif
