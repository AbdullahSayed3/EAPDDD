                                    ...
                                    <thead class="thead-light">
                                        {{-- <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $coursesDetails['total_coursers_year'] }}</td>
                                                    <th>{{ awtTrans('إجمالى عدد المتدربين') }}</th>
                                                    <td colspan="2">{{ $coursesDetails['total_apps_year'] }}</td>
                                                </tr>


                                                <tr>
                                                    <th>{{ awtTrans('عدد الدورات النوعية') }}</th>
                                                    <td>{{ $coursesDetails['total_city_year'] }}
                                                    </td>
                                                    <th>{{ awtTrans('عدد دورات الجيش والشرطة') }}</th>
                                                    <td colspan="2">
                                                        {{$coursesDetails['total_army_year'] + $coursesDetails['total_police_year'] }}
                                                    </td>
                                                </tr> --}}
                                        <tr>
