                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" autocomplete="off" name="date_to" value="{{ getRequest('date_to') }}"
                                class="form-control date-picker-input" id="inpu116" placeholder="التاريخ إلى" required>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered " cellspacing="0" style="text-align: center;">
                                <thead class="thead-light">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $coursesDetails[$key]['total_city_year'] }}
                                        </td>
                                        <th>{{ awtTrans('عدد دورات الجيش والشرطة') }}</th>
                                        <td colspan="2">
                                            {{ $coursesDetails[$key]['total_army_year'] + $coursesDetails[$key]['total_police_year'] }}
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <tfoot class="thead-light">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">{{ $coursesDetails[$key]['total_city__cost_year'] }}
                                        </td>
                                        <td colspan="2">
                                            {{ $coursesDetails[$key]['total_army__cost_year'] + $coursesDetails[$key]['total_police__cost_year'] }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th colspan="2">{{ awtTrans('التكلفة الإجمالية') }}</th>
                                        <td colspan="3">
                                            {{ $coursesDetails[$key]['total_city__cost_year'] + $coursesDetails[$key]['total_army__cost_year'] + $coursesDetails[$key]['total_police__cost_year'] }}
                                        </td>
                                    </tr>
                                </tfoot>
                                <tbody>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" cellspacing="0">
                                ...
                                <tbody class="thead-light">
                                    ...
                                    <tr>
                                        <th colspan="2">{{ awtTrans('التكلفة الإجمالية') }}</th>
                                        <td colspan="2">{{ $mainDetails['total_cost'] }} {{ awtTrans('جنيه مصري') }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
