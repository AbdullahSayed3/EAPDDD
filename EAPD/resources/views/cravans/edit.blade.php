                ...
                <div class="card-body">
                    ...
                    <form action="{{ route($route . '.update', [$model->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="checkbox" name="is_active" class="form-check-input" value="1"
                                    {{ $model->is_active == 1 ? 'checked' : '' }} id="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inpu11" class="col-sm-2 col-form-label">{{ awtTrans('name_en') }}</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" value="{{ old('title_en', $model->title_en) }}"
                                    required id="inpu11" name="title_en" placeholder="{{ awtTrans('name_en') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" value="{{ old('title_ar', $model->title_ar) }}"
                                    required id="inpu11" name="title_ar" placeholder="{{ awtTrans('name_ar') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" value="{{ old('title_fr', $model->title_fr) }}"
                                    required id="inpu11" name="title_fr" placeholder="{{ awtTrans('name_fr') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="tel" class="form-control" value="{{ old('contact', $model->contact) }}"
                                    required id="inpu11" name="contact" placeholder="{{ awtTrans('contact') }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="ship_date" required
                                    value="{{ $model->ship_date->format('Y-m-d') }}"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="arrive_date"
                                    value="{{ $model->arrive_date->format('Y-m-d') }}" required
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" min="0" name="cost" value="{{ $model->cost }}"
