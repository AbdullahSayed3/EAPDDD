            ...
            <div class="data-table">
                <table class="table table-bordered  " cellspacing="0" style="text-align: center;" >
                    ...
                    <tr>
                        ...
                        @endif
                        @if(in_array('course_id', $print_choices))
                        @if(empty($model->course))
                        @if(in_array('course_id', $print_choices))
                        <td></td>
                        @endif
                        @if(in_array('course_start_date', $print_choices))
                        <td></td>
                        @endif
                        ...
                        @endif
                        @if(in_array('course_start_date', $print_choices))
                        <td style="font-size: 18px;">{{ $model->course->start_date->format('Y-m-d')}}</td>
                        @endif
                        @if(in_array('course_end_date', $print_choices))
                        <td style="font-size: 18px;">{{$model->course->end_date->format('Y-m-d')}}</td>
                        @endif
                        @endif
                        @endif
                        ...
                        @if(in_array('birth_date', $print_choices))
                        <td>
                        @if (!empty($model->birth_date) )
                       {{\Carbon\Carbon::createFromTimeString($model->birth_date)->diff(\Carbon\Carbon::now())->format('%y')}}
                        @endif
                    </td>
                        @endif
                        ...
                        @endif
                        @if(in_array('passport_id', $print_choices))
