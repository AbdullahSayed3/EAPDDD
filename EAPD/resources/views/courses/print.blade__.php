        ...
        <div class="PDFcontent">
            ...
            <div class="data-table">
                ...
                <table class="table table-bordered " cellspacing="0" style="text-align: center;">
                    <tr>
                        <td>{{awtTrans('اسم الدورة التدريبية')}}</td>
                        <td>{{awtTrans('تاريخ البدء')}}</td>
                        <td>{{awtTrans('تاريخ الإنتهاء')}}</td>
                        <td>{{awtTrans('الجهة المنظمة')}}</td>
                        <td>{{awtTrans('إجمالي عدد المتدربين')}}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{$model->applications()->where('wait_list','false')->count()}}</td>
                    </tr>
                    @endforeach
                </table>
